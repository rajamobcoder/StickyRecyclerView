package com.mobcoder.stickyrecyclerview.utils
...
import com.mobcoder.stickyrecyclerview.databinding.ViewStickyHeaderBinding
import com.mobcoder.stickyrecyclerview.view.FruitsAdapter

class StickyHeaderDecoration(private val adapter: FruitsAdapter, root: View) :
    ItemDecoration() {
